...
<div class="flex min-h-screen items-center justify-center px-4 py-12">
    <div class="w-full max-w-md rounded-2xl border border-brand-900/10 bg-canvas-50/95 p-8 shadow-2xl shadow-brand-950/20 backdrop-blur-md">
        <div class="mb-8 flex flex-col items-center text-center">
            ...
            <h1 class="font-display text-3xl font-bold tracking-tight text-brand-950">Forgot password</h1>
            <p class="mt-1 text-sm text-brand-800/70">We will email you a link to choose a new password</p>
        </div>

    ...
    <aside id="app-sidebar"
        ...
        <div class="flex flex-1 flex-col overflow-y-auto overscroll-contain p-5 pt-6 lg:p-6">
            ...
            <nav class="space-y-1">
                ...
                @php($pw = $navItem('profile', 'Profile', 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z'))
                <a href="{{ route('profile.edit') }}" class="{{ $pw['classes'] }}" @click="sidebarOpen = false">
                    <svg class="h-5 w-5 shrink-0 opacity-90" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                        aria-hidden="true">
